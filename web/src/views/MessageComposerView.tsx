          ...
          <div className="flex rounded-md shadow-sm">
            <div className="w-full relative flex flex-grow items-stretch focus-within:z-10">
              ...
              <input
                ...
                value={textInput}
                onChange={(e) => setTextInput(e.target.value)}
                className="block w-full rounded-none rounded-l-md border-0 py-1.5 bg-zinc-900 text-white ring-0 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6"
                placeholder="Knock Knock..."
              />
            </div>
            <button
              type="submit"
              className="ml-px flex items-center space-x-1.5 rounded-3xl px-3 py-2 text-sm font-semibold bg-gradient-to-br from-emerald-500 text-gray-200 hover:bg-zinc-500"
            >
