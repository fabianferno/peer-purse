...
const navigation = {
  ...
  social: [
    {
      name: "Twitter",
      href: "https://twitter.com/PeerPurse",
      icon: (
    ...
    {
      name: "LinkedIn",
      href: "https://linkedin.com/company/PeerPurse",
      icon: (
        props: React.JSX.IntrinsicAttributes & React.SVGProps<SVGSVGElement>
      ) => (
    ...
    {
      name: "Email",
      href: "mailto:hello@PeerPurse.com",
      icon: (
        props: React.JSX.IntrinsicAttributes & React.SVGProps<SVGSVGElement>
      ) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
  ...
  return (
    <footer id="contact" className="bg-white">
      <div className="mx-auto max-w-7xl overflow-hidden px-6 py-20 sm:py-24 lg:px-8">
        <p className="text-1xl lg:text-3xl leading-[3rem] text-center text-zinc-900 font-bold">
        ...
        <p className="mt-10 text-center text-md leading-5 text-zinc-500">
          &copy; 2023 PeerPurse Labs. All rights reserved. <br />
          PeerPurse Labs are trademarks of PeerPurse Technologies.
        </p>
      </div>
    </footer>
  );
